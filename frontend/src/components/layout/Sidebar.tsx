...
export function Sidebar() {
  ...
  return (
    <>
      <aside
        className={cn(
          'hidden lg:flex flex-col border-r border-white/10 bg-dark-card/95 text-white backdrop-blur-2xl transition-all duration-300 min-h-[calc(100vh-4rem)]',
          collapsed ? 'w-16' : 'w-64'
        )}
      >
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active ? 'bg-[#F1FEC8] text-[#23212C] font-bold shadow-sm' : 'text-white/70 hover:bg-white/10 hover:text-white'
                )}
              >
                {item.icon}
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 flex border-t border-white/10 bg-dark-card/95 backdrop-blur-2xl lg:hidden">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? 'text-[#F1FEC8]' : 'text-white/60'
              )}
            >
              {item.icon}
